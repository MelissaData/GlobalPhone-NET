...
namespace GlobalPhone_NET
{
    public partial class Form1 : Form
    {
        ...
        private void verificationType_SelectedIndexChanged(object sender, EventArgs e)
        {
            //optVerificationType.SelectedText(optVerificationType.GetItemText);
        }
        ...
        private void optDefaultCallingCode_TextChanged(object sender, EventArgs e)
        {
